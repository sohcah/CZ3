  ...
  return (
    <div>
      ...
      <main className="flex flex-col items-stretch w-full p-4">
        <h2 className="font-display text-4xl">Terms and Conditions</h2>
        <p className="mt-2">
          ...
          related to it, still belong to Sam Hindess.
        </p>
        <p className="mt-2">
          Sam Hindess is committed to ensuring that the app is as useful and efficient as possible.
        ...
        <p className="mt-2">
          The CuppaZee app stores and processes personal data that you have provided to us, in order
          to provide my Service. It's your responsibility to keep your phone and access to the app
          ...
          mean that the CuppaZee app won't work properly or at all.
        </p>
        <div>
          <p className="mt-2">
        ...
        <p className="mt-2">
          You should be aware that there are certain things that Sam Hindess will not take
          ...
          provider, but Sam Hindess cannot take responsibility for the app not working at full
        ...
        <p className="mt-2">
          Along the same lines, Sam Hindess cannot always take responsibility for the way you use
          the app i.e. You need to make sure that your device stays charged - if it runs out of
          battery and you can't turn it on to avail the Service, Sam Hindess cannot accept
          responsibility.
        </p>
        <p className="mt-2">
          With respect to Sam Hindess's responsibility for your use of the app, when you're using
          ...
          so that we can make it available to you. Sam Hindess accepts no liability for any loss,
        ...
        <p className="mt-2">
          ...
          if you want to keep using the app. Sam Hindess does not promise that it will always update
        ...
        <h3 className="text-xl font-bold mt-4">Changes to This Terms and Conditions</h3>
        <p className="mt-2">
        ...
        <p className="mt-2">
          These terms and conditions are effective as of <b>2022-01-17</b>.
        </p>
